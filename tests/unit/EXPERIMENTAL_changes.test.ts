/**
 * Unit tests for EXPERIMENTAL_changes RPC method.
 * This file was auto-generated - do not edit manually.
 * Generated at: 2025-07-23T01:21:07.567Z
 */
...
describe('EXPERIMENTAL_changes - Unit Tests', () => {
  describe('Schema Validation', () => {
    it('should have valid request and response schemas', () => {
      expect(hasValidSchemas('EXPERIMENTAL_changes')).toBe(true);
      expect(methodSchemas['EXPERIMENTAL_changes']?.request).toBeDefined();
      expect(methodSchemas['EXPERIMENTAL_changes']?.response).toBeDefined();
    });
  });
  ...
  describe('Request Validation', () => {
    it('should create valid request structure', () => {
      ...
      const request = createJsonRpcRequest('EXPERIMENTAL_changes', mockParams);

      expect(request.jsonrpc).toBe('2.0');
      expect(request.method).toBe('EXPERIMENTAL_changes');
    ...
    it('should generate and validate request with schema', () => {
      const request = generateRequest('EXPERIMENTAL_changes');
      ...
      const isValid = validateRequest('EXPERIMENTAL_changes', request);
    ...
    it('should fail validation for invalid request', () => {
      ...
      const isValid = validateRequest('EXPERIMENTAL_changes', invalidRequest);
  ...
  describe('Response Validation', () => {
    ...
    it('should generate and validate response with schema', () => {
      const response = generateResponse('EXPERIMENTAL_changes', 'test-id');
      ...
      const isValid = validateResponse('EXPERIMENTAL_changes', response);
    ...
    it('should fail validation for invalid response', () => {
      ...
      const isValid = validateResponse('EXPERIMENTAL_changes', invalidResponse);
      expect(isValid).toBe(false);
    });
  });
