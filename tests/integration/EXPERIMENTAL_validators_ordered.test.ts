/**
 * Integration tests for EXPERIMENTAL_validators_ordered RPC method.
...
describe('EXPERIMENTAL_validators_ordered - Integration Tests', () => {
  ...
  describe('Mock RPC Tests', () => {
    it('should handle EXPERIMENTAL_validators_ordered request with mock response', async () => {
      ...
      server.use(
        http.post(endpoint, async ({ request }) => {
          ...
          expect(body?.method).toBe('EXPERIMENTAL_validators_ordered');
    ...
    it('should validate EXPERIMENTAL_validators_ordered request structure', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_validators_ordered',
        'test-2',
      );
    ...
    it('should handle EXPERIMENTAL_validators_ordered server error response', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_validators_ordered',
        'test-3',
      );
    ...
    it('should handle EXPERIMENTAL_validators_ordered network error', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_validators_ordered',
        'test-4',
      );
    ...
    it('should reject invalid EXPERIMENTAL_validators_ordered request', async () => {
    ...
    it('should handle EXPERIMENTAL_validators_ordered request with timeout simulation', async () => {
      // Pre-generate test data to ensure consistency
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_validators_ordered',
        'test-6',
