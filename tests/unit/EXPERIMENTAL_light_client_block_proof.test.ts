/**
 * Unit tests for EXPERIMENTAL_light_client_block_proof RPC method.
...
describe('EXPERIMENTAL_light_client_block_proof - Unit Tests', () => {
  ...
  describe('Request Validation', () => {
    it('should create valid request structure', () => {
      ...
      expect(request.method).toBe('EXPERIMENTAL_light_client_block_proof');
    ...
    it('should generate and validate request with schema', () => {
      const request = generateRequest('EXPERIMENTAL_light_client_block_proof');
