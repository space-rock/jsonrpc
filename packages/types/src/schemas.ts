...
export const CongestionControlConfigViewSchema: v.GenericSchema<t.CongestionControlConfigView> =
  v.lazy(() =>
    v.object({
      allowedShardOutgoingGas: NearGasSchema,
      maxCongestionIncomingGas: NearGasSchema,
      maxCongestionMemoryConsumption: v.number(),
      maxCongestionMissedChunks: v.number(),
      maxCongestionOutgoingGas: NearGasSchema,
      maxOutgoingGas: NearGasSchema,
      maxTxGas: NearGasSchema,
      minOutgoingGas: NearGasSchema,
      minTxGas: NearGasSchema,
...
export const ExtCostsConfigViewSchema: v.GenericSchema<t.ExtCostsConfigView> =
  v.lazy(() =>
    v.object({
      altBn128G1MultiexpBase: NearGasSchema,
      altBn128G1MultiexpElement: NearGasSchema,
      altBn128G1SumBase: NearGasSchema,
      altBn128G1SumElement: NearGasSchema,
      altBn128PairingCheckBase: NearGasSchema,
      altBn128PairingCheckElement: NearGasSchema,
      base: NearGasSchema,
      bls12381G1MultiexpBase: NearGasSchema,
      bls12381G1MultiexpElement: NearGasSchema,
      bls12381G2MultiexpBase: NearGasSchema,
      bls12381G2MultiexpElement: NearGasSchema,
      bls12381MapFp2ToG2Base: NearGasSchema,
      bls12381MapFp2ToG2Element: NearGasSchema,
      bls12381MapFpToG1Base: NearGasSchema,
      bls12381MapFpToG1Element: NearGasSchema,
      bls12381P1DecompressBase: NearGasSchema,
      bls12381P1DecompressElement: NearGasSchema,
      bls12381P1SumBase: NearGasSchema,
      bls12381P1SumElement: NearGasSchema,
      bls12381P2DecompressBase: NearGasSchema,
      bls12381P2DecompressElement: NearGasSchema,
      bls12381P2SumBase: NearGasSchema,
      bls12381P2SumElement: NearGasSchema,
      bls12381PairingBase: NearGasSchema,
      bls12381PairingElement: NearGasSchema,
      contractCompileBase: NearGasSchema,
      contractCompileBytes: NearGasSchema,
      contractLoadingBase: NearGasSchema,
      contractLoadingBytes: NearGasSchema,
      ecrecoverBase: NearGasSchema,
      ed25519VerifyBase: NearGasSchema,
      ed25519VerifyByte: NearGasSchema,
      keccak256Base: NearGasSchema,
      keccak256Byte: NearGasSchema,
      keccak512Base: NearGasSchema,
      keccak512Byte: NearGasSchema,
      logBase: NearGasSchema,
      logByte: NearGasSchema,
      promiseAndBase: NearGasSchema,
      promiseAndPerPromise: NearGasSchema,
      promiseReturn: NearGasSchema,
      readCachedTrieNode: NearGasSchema,
      readMemoryBase: NearGasSchema,
      readMemoryByte: NearGasSchema,
      readRegisterBase: NearGasSchema,
      readRegisterByte: NearGasSchema,
      ripemd160Base: NearGasSchema,
      ripemd160Block: NearGasSchema,
      sha256Base: NearGasSchema,
      sha256Byte: NearGasSchema,
      storageHasKeyBase: NearGasSchema,
      storageHasKeyByte: NearGasSchema,
      storageIterCreateFromByte: NearGasSchema,
      storageIterCreatePrefixBase: NearGasSchema,
      storageIterCreatePrefixByte: NearGasSchema,
      storageIterCreateRangeBase: NearGasSchema,
      storageIterCreateToByte: NearGasSchema,
      storageIterNextBase: NearGasSchema,
      storageIterNextKeyByte: NearGasSchema,
      storageIterNextValueByte: NearGasSchema,
      storageLargeReadOverheadBase: NearGasSchema,
      storageLargeReadOverheadByte: NearGasSchema,
      storageReadBase: NearGasSchema,
      storageReadKeyByte: NearGasSchema,
      storageReadValueByte: NearGasSchema,
      storageRemoveBase: NearGasSchema,
      storageRemoveKeyByte: NearGasSchema,
      storageRemoveRetValueByte: NearGasSchema,
      storageWriteBase: NearGasSchema,
      storageWriteEvictedByte: NearGasSchema,
      storageWriteKeyByte: NearGasSchema,
      storageWriteValueByte: NearGasSchema,
      touchingTrieNode: NearGasSchema,
      utf16DecodingBase: NearGasSchema,
      utf16DecodingByte: NearGasSchema,
      utf8DecodingBase: NearGasSchema,
      utf8DecodingByte: NearGasSchema,
      validatorStakeBase: NearGasSchema,
      validatorTotalStakeBase: NearGasSchema,
      writeMemoryBase: NearGasSchema,
      writeMemoryByte: NearGasSchema,
      writeRegisterBase: NearGasSchema,
      writeRegisterByte: NearGasSchema,
      yieldCreateBase: NearGasSchema,
      yieldCreateByte: NearGasSchema,
      yieldResumeBase: NearGasSchema,
      yieldResumeByte: NearGasSchema,
    }),
  );
...
export const FeeSchema: v.GenericSchema<t.Fee> = v.lazy(() =>
  v.object({
    execution: NearGasSchema,
    sendNotSir: NearGasSchema,
    sendSir: NearGasSchema,
  }),
);
...
export const LimitConfigSchema: v.GenericSchema<t.LimitConfig> = v.lazy(() =>
  v.object({
    ...
    maxTotalPrepaidGas: NearGasSchema,
...
export const NearGasSchema: v.GenericSchema<t.NearGas> = v.lazy(() =>
  v.number(),
);
...
export const RpcClientConfigResponseSchema: v.GenericSchema<t.RpcClientConfigResponse> =
  v.lazy(() =>
    v.object({
      ...
      maxGasBurntView: v.optional(v.union([NearGasSchema, v.null()])),
