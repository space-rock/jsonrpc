/**
 * Unit tests for gas_price RPC method.
 * This file was auto-generated - do not edit manually.
 * Generated at: 2025-07-22T08:49:17.682Z
 */
...
describe('gas_price - Unit Tests', () => {
  describe('Schema Validation', () => {
    it('should have valid request and response schemas', () => {
      expect(hasValidSchemas('gas_price')).toBe(true);
      expect(methodSchemas['gas_price']?.request).toBeDefined();
      expect(methodSchemas['gas_price']?.response).toBeDefined();
    });
  });
  ...
  describe('Request Validation', () => {
    it('should create valid request structure', () => {
      ...
      const request = createJsonRpcRequest('gas_price', mockParams);

      expect(request.jsonrpc).toBe('2.0');
      expect(request.method).toBe('gas_price');
    ...
    it('should generate and validate request with schema', () => {
      const request = generateRequest('gas_price');
      ...
      const isValid = validateRequest('gas_price', request);
  ...
  describe('Response Validation', () => {
    ...
    it('should generate and validate response with schema', () => {
      const response = generateResponse('gas_price', 'test-id');
      ...
      const isValid = validateResponse('gas_price', response);
    ...
    it('should fail validation for invalid response', () => {
      ...
      const isValid = validateResponse('gas_price', invalidResponse);
      expect(isValid).toBe(false);
    });
  });
