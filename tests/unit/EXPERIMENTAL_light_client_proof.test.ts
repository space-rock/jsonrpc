/**
 * Unit tests for EXPERIMENTAL_light_client_proof RPC method.
 * This file was auto-generated - do not edit manually.
 * Generated at: 2025-07-20T16:55:18.161Z
 */
...
describe('EXPERIMENTAL_light_client_proof - Unit Tests', () => {
  describe('Schema Validation', () => {
    it('should have valid request and response schemas', () => {
      expect(hasValidSchemas('EXPERIMENTAL_light_client_proof')).toBe(true);
      expect(
  ...
  describe('Request Validation', () => {
    it('should create valid request structure', () => {
      ...
      expect(request.method).toBe('EXPERIMENTAL_light_client_proof');
    ...
    it('should generate and validate request with schema', () => {
      const request = generateRequest('EXPERIMENTAL_light_client_proof');
