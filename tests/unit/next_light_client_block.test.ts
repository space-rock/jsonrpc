/**
 * Unit tests for next_light_client_block RPC method.
 * This file was auto-generated - do not edit manually.
 * Generated at: 2025-07-20T16:55:18.166Z
 */
...
describe('next_light_client_block - Unit Tests', () => {
  ...
  describe('Request Validation', () => {
    it('should create valid request structure', () => {
      ...
      expect(request.method).toBe('next_light_client_block');
    ...
    it('should generate and validate request with schema', () => {
      const request = generateRequest('next_light_client_block');
      ...
      const isValid = validateRequest('next_light_client_block', request);
  ...
  describe('Response Validation', () => {
    ...
    it('should generate and validate response with schema', () => {
      const response = generateResponse('next_light_client_block', 'test-id');
      ...
      const isValid = validateResponse('next_light_client_block', response);
