/**
 * Integration tests for EXPERIMENTAL_genesis_config RPC method.
...
describe('EXPERIMENTAL_genesis_config - Integration Tests', () => {
  ...
  describe('Mock RPC Tests', () => {
    it('should handle EXPERIMENTAL_genesis_config request with mock response', async () => {
      ...
      server.use(
        http.post(endpoint, async ({ request }) => {
          ...
          expect(body?.method).toBe('EXPERIMENTAL_genesis_config');
    ...
    it('should validate EXPERIMENTAL_genesis_config request structure', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_genesis_config',
        'test-2',
      );
    ...
    it('should handle EXPERIMENTAL_genesis_config server error response', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_genesis_config',
        'test-3',
      );
    ...
    it('should handle EXPERIMENTAL_genesis_config network error', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_genesis_config',
        'test-4',
      );
    ...
    it('should reject invalid EXPERIMENTAL_genesis_config request', async () => {
    ...
    it('should handle EXPERIMENTAL_genesis_config request with timeout simulation', async () => {
      // Pre-generate test data to ensure consistency
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_genesis_config',
        'test-6',
