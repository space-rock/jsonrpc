/**
 * Integration tests for EXPERIMENTAL_changes_in_block RPC method.
...
describe('EXPERIMENTAL_changes_in_block - Integration Tests', () => {
  ...
  describe('Mock RPC Tests', () => {
    it('should handle EXPERIMENTAL_changes_in_block request with mock response', async () => {
      ...
      server.use(
        http.post(endpoint, async ({ request }) => {
          ...
          expect(body?.method).toBe('EXPERIMENTAL_changes_in_block');
    ...
    it('should validate EXPERIMENTAL_changes_in_block request structure', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_changes_in_block',
        'test-2',
      );
    ...
    it('should handle EXPERIMENTAL_changes_in_block server error response', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_changes_in_block',
        'test-3',
      );
    ...
    it('should handle EXPERIMENTAL_changes_in_block network error', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_changes_in_block',
        'test-4',
      );
    ...
    it('should reject invalid EXPERIMENTAL_changes_in_block request', async () => {
    ...
    it('should handle EXPERIMENTAL_changes_in_block request with timeout simulation', async () => {
      // Pre-generate test data to ensure consistency
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_changes_in_block',
        'test-6',
