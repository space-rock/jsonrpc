/**
 * Unit tests for changes RPC method.
 * This file was auto-generated - do not edit manually.
 * Generated at: 2025-07-22T08:49:17.681Z
 */
...
describe('changes - Unit Tests', () => {
  describe('Schema Validation', () => {
    it('should have valid request and response schemas', () => {
      expect(hasValidSchemas('changes')).toBe(true);
      expect(methodSchemas['changes']?.request).toBeDefined();
      expect(methodSchemas['changes']?.response).toBeDefined();
    });
  });
  ...
  describe('Request Validation', () => {
    it('should create valid request structure', () => {
      ...
      const request = createJsonRpcRequest('changes', mockParams);

      expect(request.jsonrpc).toBe('2.0');
      expect(request.method).toBe('changes');
    ...
    it('should generate and validate request with schema', () => {
      const request = generateRequest('changes');
      ...
      const isValid = validateRequest('changes', request);
  ...
  describe('Response Validation', () => {
    ...
    it('should generate and validate response with schema', () => {
      const response = generateResponse('changes', 'test-id');
      ...
      const isValid = validateResponse('changes', response);
    ...
    it('should fail validation for invalid response', () => {
      ...
      const isValid = validateResponse('changes', invalidResponse);
      expect(isValid).toBe(false);
    });
  });
