/**
 * Integration tests for EXPERIMENTAL_light_client_proof RPC method.
...
describe('EXPERIMENTAL_light_client_proof - Integration Tests', () => {
  ...
  describe('Mock RPC Tests', () => {
    it('should handle EXPERIMENTAL_light_client_proof request with mock response', async () => {
      ...
      server.use(
        http.post(endpoint, async ({ request }) => {
          ...
          expect(body?.method).toBe('EXPERIMENTAL_light_client_proof');
    ...
    it('should validate EXPERIMENTAL_light_client_proof request structure', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_light_client_proof',
        'test-2',
      );
    ...
    it('should handle EXPERIMENTAL_light_client_proof server error response', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_light_client_proof',
        'test-3',
      );
    ...
    it('should handle EXPERIMENTAL_light_client_proof network error', async () => {
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_light_client_proof',
        'test-4',
      );
    ...
    it('should reject invalid EXPERIMENTAL_light_client_proof request', async () => {
    ...
    it('should handle EXPERIMENTAL_light_client_proof request with timeout simulation', async () => {
      // Pre-generate test data to ensure consistency
      const mockParams = generateDeterministicMockParams(
        'EXPERIMENTAL_light_client_proof',
        'test-6',
